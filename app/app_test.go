...
func newStartedApp(
	...
	err = g.Provide(
		...
		&inject.Object{Value: transmit.NewDefaultTransmission(c, upstreamClient, metricsr, "upstream"), Name: "upstreamTransmission"},
		&inject.Object{Value: transmit.NewDefaultTransmission(c, peerClient, metricsr, "peer"), Name: "peerTransmission"},
